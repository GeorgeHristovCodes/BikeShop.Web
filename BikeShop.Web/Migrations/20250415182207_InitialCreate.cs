    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "DRAG", 0, "Лек и бърз шосеен велосипед, идеален за състезания и дълги карания по асфалт.", "M", "/images/demo-bicycles/road1-1.jpg", true, "Drag C1 Road", 3200m, 5, 1 },
                    { 2, "SPECIALIZED", 0, "Надежден и ефективен шосеен велосипед с отлична аеродинамика.", "L", "/images/demo-bicycles/road2-1.jpg", true, "Specialized Allez", 4600m, 3, 1 },
                    { 3, "NS BIKES", 1, "Маневрен хардтейл за трикове и каране в градска среда.", "S", "/images/demo-bicycles/hardtail1-1.jpg", true, "NS Bikes Zircus", 2800m, 4, 1 },
                    { 4, "DRAG", 1, "Планински велосипед с твърда рамка, идеален за off-road каране.", "M", "/images/demo-bicycles/hardtail2-1.jpg", true, "Drag Hardy Pro", 3000m, 7, 1 },
                    { 5, "YT INDUSTRIES", 2, "Сериозен планински велосипед с пълно окачване за максимален контрол по пресечени терени.", "L", "/images/demo-bicycles/full1-1.jpg", true, "YT Jeffsy Core", 5200m, 6, 1 },
                    { 6, "SPECIALIZED", 2, "Премиум MTB за тежки терени. Със здрава рамка и модерна геометрия.", "XL", "/images/demo-bicycles/full2-1.jpg", true, "Specialized Stumpjumper Evo", 5800m, 2, 1 },
                    { 7, "DRAG", 3, "Удобен и стилен градски велосипед – идеален за ежедневно придвижване.", "M", "/images/demo-bicycles/city1-1.jpg", true, "Drag City Rider", 2200m, 8, 1 },
                    { 8, "NS BIKES", 3, "Хибриден велосипед за град и офроуд. Съчетава комфорт и здравина.", "L", "/images/demo-bicycles/city2-1.jpg", true, "NS Bikes Metropolis", 2500m, 4, 1 },
                    { 9, "DRAG", 4, "Цветен велосипед за деца от 5 до 8 години. Сигурен и лек.", "XS", "/images/demo-bicycles/kid1-1.jpg", true, "Drag Kid 20\"", 950m, 10, 1 },
                    { 10, "YT INDUSTRIES", 4, "Качествен велосипед за деца от 8 до 12 г. Стабилен и удобен за каране.", "S", "/images/demo-bicycles/kid2-1.jpg", true, "YT Primus 24\"", 1050m, 9, 1 },
